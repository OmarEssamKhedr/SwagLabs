...
public class P05_OverviewPage {
    ...
    public Float getSubTotal() {
        //LogsUtils.info("Sub Total Price: " + Utility.getText(driver, subTotal).replace("Item total: $", ""));
        return Float.parseFloat(Utility.getText(driver, subTotal).replace("Item total: $", ""));
    }

    public Float getTax() {
        //LogsUtils.info("Tax Price: " + Utility.getText(driver, tax).replace("Tax: $", ""));
    ...
    public P06_FinishingOrderPage clickingOnFinishButton() {
